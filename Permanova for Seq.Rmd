---
#This is a PERMANOVA I performed on my sequencing data, however, I continued with the generalized linear mixed model framework of MaAslin2 
#This code was adapted from Kait Al (https://github.com/kait-al/Microbiome_SOPs/tree/main) 
---
...
library(zCompositions) #used for managing compositional data
library(vegan) # for permanova
library(CoDaSeq)
library(Maaslin2) #GLMM framework
library(dplyr)
```
